 ...
 * decisions without depending on ace-copilot-security directly (dependency inversion).
 *
 * <p>Implementations typically wrap a {@code PermissionManager} from ace-copilot-security.
 */
@FunctionalInterface
