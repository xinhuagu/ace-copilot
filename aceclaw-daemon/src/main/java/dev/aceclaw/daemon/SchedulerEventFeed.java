...
/**
 * In-memory ring buffer for scheduler events, exposed via polling RPC.
 */
public final class SchedulerEventFeed {
    ...
    public SchedulerEventFeed() {
        this(DEFAULT_MAX_EVENTS);
    }

    public SchedulerEventFeed(int maxEvents) {
        if (maxEvents <= 0) {
    ...
    public void append(SchedulerEvent event) {
    ...
    public record Entry(long sequence, SchedulerEvent event) {}
