 ...
 *
 * <p>The index is global to the AceCopilot home directory and supports lightweight
...
public final class HistoricalLogIndex {
    ...
    public HistoricalLogIndex(Path aceCopilotHome) throws IOException {
        Objects.requireNonNull(aceCopilotHome, "aceCopilotHome");
        this.indexDir = aceCopilotHome.resolve(INDEX_DIR);
