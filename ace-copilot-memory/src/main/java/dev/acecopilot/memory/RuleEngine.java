...
/**
 * Loads rules from {@code {project}/.ace-copilot/rules/*.md} and matches them
...
public final class RuleEngine {
    ...
    private static final String RULES_DIR = ".ace-copilot/rules";
    ...
    /**
     * Loads rules from the project's {@code .ace-copilot/rules/} directory.
     *
